    ...
    private static boolean checkWin(char dot){
        ...
        for(int y = 0; y < field.length; y++) {
            ...
            for (int x = 0; x < field.length; x++) {
                ...
                if (x == y && field[y][x] == dot) {
                    counterDiag1++;
                }
                if (x == field.length - y - 1 && field[y][x] == dot) {
                    counterDiag2++;
                }
            }
            if (counterX == winRate || counterY == winRate || counterDiag1 == winRate || counterDiag2 == winRate)
                return true;
        }
        return false;
    }
